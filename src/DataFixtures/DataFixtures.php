...
class DataFixtures extends Fixture
{
    ...
    //  Cette fonction load() sera executer en ligne de commande, php bin/console doctrine:fixture:load --append
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        foreach ($categories as $cat) {
            ...
            // entityManager, on appel sa méthode persist() pour insérer en BDD $categorie
